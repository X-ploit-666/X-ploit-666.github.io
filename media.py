...
def replace_footer_content(file_path):
    ...
    vvar="""onclick="this.href='whatsapp://send?&phone=+4915750178884&text=%0A- Quantity: ' + document.getElementsByClassName('quantity__input')[0].value + '%0A- Link: https://panel-pix.com' + encodeURIComponent(window.location.pathname);"""

    # Regex pattern to find <div> elements with class 'footer-block__details-content rte'
    pattern = r'''href=\"https:\/\/wa.me\/8613378643944'''
